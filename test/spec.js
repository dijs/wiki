...
describe('Wiki Methods', () => {
  ...
  it('Search handle a foreign redirect', () => {
      ...
      .get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=Boletus%20edulis&format=json&action=query&origin=*&redirects=')
      .once()
      .reply(200, JSON.parse(fs.readFileSync('./test/data/redirect.json')))
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=%D0%91%D0%B5%D0%BB%D1%8B%D0%B9%20%D0%B3%D1%80%D0%B8%D0%B1&format=json&action=query&origin=*&redirects=')
      .once()
	...
	it('Search should limit properly', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?list=search&srsearch=batman&srlimit=7&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('Random should return the correct number of results', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?list=random&rnnamespace=0&rnlimit=3&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('Should return correct page', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=Batman&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('Should error if page not found', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=Nope&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, {
				query: {
					pages: []
	...
	it('Should return page from coordinates', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?list=geosearch&gsradius=1000&gscoord=32.329%7C-96.136&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('Should be able to choose wikipedia language', () => {
		nock('http://fr.wikipedia.org')
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=France&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865886161.json')))
			.get('/w/api.php?prop=extracts&explaintext=&exintro=&titles=France&format=json&action=query&origin=*&redirects=')
			.once()
...
describe('Page Methods', () => {
	...
	before((done) => {
		...
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should get html from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=revisions&rvprop=content&rvlimit=1&rvparse=&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should get content from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=extracts&explaintext=&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should get summary from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=extracts&explaintext=&exintro=&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should get references from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=extlinks&ellimit=max&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should get links from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=links&plnamespace=0&pllimit=100&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865893591.json')))
			.get('/w/api.php?prop=links&plnamespace=0&pllimit=100&titles=Luke%20Skywalker&plcontinue=53602%7C0%7CJango_Fett&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865894283.json')))
			.get('/w/api.php?prop=links&plnamespace=0&pllimit=100&titles=Luke%20Skywalker&plcontinue=53602%7C0%7CSkywalker_family&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865895017.json')))
			.get('/w/api.php?prop=links&plnamespace=0&pllimit=100&titles=Luke%20Skywalker&plcontinue=53602%7C0%7CYoda&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should get partial links from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=links&plnamespace=0&pllimit=1&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865893591.json')))
	...
	it('should get categories from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=categories&pllimit=100&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865898699.json')))
			.get('/w/api.php?prop=categories&pllimit=100&titles=Luke%20Skywalker&clcontinue=53602%7CFictional_hermits&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865900848.json')))
			.get('/w/api.php?prop=categories&pllimit=100&titles=Luke%20Skywalker&clcontinue=53602%7CWikipedia_protected_pages_without_expiry&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should get partial categories from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=categories&pllimit=1&titles=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865898699.json')));
	...
	it('should get backlinks from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865905740.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=1%7C398180&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865907167.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=0%7C1759525&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865907889.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=0%7C3137992&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865908539.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=2%7C5279310&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865909279.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=3%7C9378934&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865910008.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=4%7C14504799&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865910768.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=0%7C18617763&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865911458.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=0%7C23219359&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865912046.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=3%7C32891902&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865912820.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=4%7C40396152&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865913602.json')))
			.get('/w/api.php?list=backlinks&bllimit=100&bltitle=Luke%20Skywalker&blcontinue=0%7C48176993&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should get partial backlinks from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?list=backlinks&bllimit=1&bltitle=Luke%20Skywalker&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865905740.json')))
	...
	it('should get coordinates from an article', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=Texas&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865916169.json')))
			.get('/w/api.php?prop=coordinates&titles=Texas&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should parse coordinates located in infobox', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=Catanzaro&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/coord_test_infobox_initial.json')))
			.get('/w/api.php?prop=coordinates&titles=Catanzaro&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/coord_test_infobox_nullresp.json')))
			.get('/w/api.php?prop=revisions&rvprop=content&rvsection=0&titles=Catanzaro&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should parse deprecated format coordinates', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=Solok&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/coord_test_deprecated_initial.json')))
			.get('/w/api.php?prop=coordinates&titles=Solok&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/coord_test_deprecated_nullresp.json')))
			.get('/w/api.php?prop=revisions&rvprop=content&rvsection=0&titles=Solok&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should know who batman is', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=revisions&rvprop=content&rvsection=0&titles=Batman&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should determine information from metadata', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=revisions&rvprop=content&rvsection=0&titles=Elizabeth%20II&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/queen_1465350664332.json')))
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=Elizabeth%20II&format=json&action=query&origin=*&redirects=')
			.once()
	...
	it('should handle empty images properly', () => {
		nock('http://en.wikipedia.org')
			.get('/w/api.php?prop=info%7Cpageprops&inprop=url&ppprop=disambiguation&titles=The%20Future%20Kings%20of%20England&format=json&action=query&origin=*&redirects=')
			.once()
			.reply(200, JSON.parse(fs.readFileSync('./test/data/1463865918307.json')))
			.get('/w/api.php?generator=images&gimlimit=max&prop=imageinfo&iiprop=url&titles=The%20Future%20Kings%20of%20England&format=json&action=query&origin=*&redirects=')
			.once()
